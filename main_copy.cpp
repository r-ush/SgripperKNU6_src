...
void print_run(void *arg)
{
	...
	while (1)
	{
		...
		if (1)
		{
			...
			{
				rt_printf("\n\e[32;1m\tPID value: %d, Current Torque: %d Slave %d / Pos: %d,  Vel: %d  Abspos %d \e[0m",  TargetTor[i], ActualTor[i], i, ActualPos[i], ActualVel[i], AuxiliaryPositionActualValue[i]);
